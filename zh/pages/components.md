...
Avalonia Fluent UI 提供了丰富的 UI 控件，按照功能分类如下：

## 基础输入

- [按钮 (Button)](/zh/components/basic_input/button)
- [滑动条 (Slider)](/zh/components/basic_input/slider)
- [下拉框 (ComboBox)](/zh/components/basic_input/combobox)

## 日期和时间

- [日历选择器 (CalendarDatePicker)](/zh/components/date_time/calendar_date_picker)
- [时间选择器 (TimePicker)](/zh/components/date_time/time_picker)
...
- [卡片 (Card)](/zh/components/layout/card)

## 导航
- [面包屑导航 (BreadcrumbBar)](/zh/components/navigation/breadcrumb_bar)
- [侧边导航 (NavigationView)](/zh/components/navigation/navigation_view)
- [选项卡控件 (TabControl)](/zh/components/navigation/tab_control)
- [顶部导航 (SegmentedView)](/zh/components/navigation/top_navigation)

## 滚动

- [滚动区域 (ScrollViewer)](/zh/components/scroll/smooth_scroll)
